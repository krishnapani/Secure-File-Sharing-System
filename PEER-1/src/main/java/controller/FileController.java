...
public class FileController {
    ...
    public RedirectView sendFileFunc(@PathVariable String id) throws Exception {
        ...
        String params = "IP=" + srcDataIP + "&port=" + srcDataPort + "&name=" + file.getFilename() + "&type="
                + file.getFileType() + "&checksum=" + checksum;
    ...
    public RedirectView receiveFileFunc(@RequestParam String IP, @RequestParam String port, @RequestParam String name,
            @RequestParam String type, @RequestParam String checksum) throws Exception {
        RedirectView redirectView = new RedirectView();
        redirectView.setUrl("http://" + mainIP + ":" + mainPort + "/showAllFiles");
        redirectView.setStatusCode(HttpStatus.TEMPORARY_REDIRECT);
        ...
        CustomMultipartFile custom = new CustomMultipartFile(output.getFile(), output.getFilename(),
                output.getFileType(), (long) Integer.parseInt(output.getFileSize()));
